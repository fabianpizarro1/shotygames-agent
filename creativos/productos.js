...
const ANGULOS = {
  ...
  precio_valor:   'Enfatiza lo que recibes por el precio: cuánto ahorra vs. comprar por separado y todo lo que viene incluido. OJO: el envío es gratis en TODO el catálogo, así que no sirve como diferenciador del combo.',
...
const PRODUCTOS = [
  ...
  },
  {
    ...
    resumen: 'Elige 2 torres + regalos digitales. Ahorras $17 vs. comprarlas por separado ($56).',
    beneficios: ['2 torres a elección', 'Ahorras $17', 'Envío gratis', 'Guías de regalo'],
  ...
  },
  {
    ...
    resumen: 'Las 3 torres: Normal + Picante + Parejas. $49 en vez de $84 por separado — ahorras $35.',
    beneficios: ['Las 3 versiones', 'Ahorras $35', 'Envío gratis', 'Listo para cualquier plan'],
    angulos: ['precio_valor', 'hero', 'regalo'],
  },
  {
    id: 'torre-parejas', nombre: 'Torre de Shots Parejas', precio: 28, avatar: 'parejas',
    imagen: `${BASE_IMG}/torre-parejas-foto.jpg`,
    resumen: 'Juego de retos para parejas. Sube la tensión, salgan de la rutina. $28 con envío gratis e incluye guía de 30 posiciones.',
    beneficios: ['Retos para dos', 'Guía de 30 posiciones de regalo', 'Envío gratis', 'Sube la temperatura'],
    angulos: ['dolor_solucion', 'regalo', 'lifestyle'],
  },
  {
    id: 'torre-normal', nombre: 'Torre de Shots Normal', precio: 28, avatar: 'grupos',
    imagen: `${BASE_IMG}/torre-normal-foto.jpg`,
    resumen: 'El clásico para prender cualquier reunión. Retos divertidos para grupos. $28 con envío gratis.',
    beneficios: ['Prende la fiesta', 'Fácil de jugar', 'Envío gratis', 'Guía de 25 juegos de regalo'],
    angulos: ['lifestyle', 'precio_valor', 'hero'],
  },
  {
    id: 'torre-picante', nombre: 'Torre de Shots Picante', precio: 28, avatar: 'grupos',
    imagen: `${BASE_IMG}/torre-picante-brillo.jpg`,
    resumen: 'Para reuniones más atrevidas y sin vergüenza. Retos picantes que rompen el hielo. $28 con envío gratis.',
    beneficios: ['Retos atrevidos', 'Rompe la vergüenza', 'Envío gratis', 'Guía de 25 juegos de regalo'],
