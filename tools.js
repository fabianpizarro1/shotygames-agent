const tools = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        emparejados: { type: "string", description: "Cantidad de Emparejados incluidos en el pedido junto con productos físicos (ej: Torre Parejas + Dados + Emparejados). Va en la columna EMPA de PEDIDOS y TAMBIÉN en la guía de DROPI como producto propio." },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        emparejados: { type: "string", description: "Cantidad de Emparejados. SÍ va en la guía: es un producto propio en DROPI (EMPAREJADOS DIGITAL), ya no se agrupa en un combo." },
