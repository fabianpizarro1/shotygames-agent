...
const combos = [
  ...
  },
  {
    ...
    savings: 15,
    icon: Package,
    includes: ["Torre Normal", "Torre Picante", "Torre Parejas", "🎁 Shot Bidu de regalo", "🎁 Guía digital de 30 posiciones sexuales", "🎁 Guía digital de 20 juegos para fiestas"],
    badge: "MÁS VENDIDO",
  ...
  },
  {
    ...
    savings: 20,
    icon: Heart,
    includes: ["Torre Normal", "Torre Picante", "Torre Parejas", "Enganchados", "🎁 Botella de regalo", "🎁 Guía digital de 30 posiciones sexuales", "🎁 Guía digital de 20 juegos para fiestas"],
    badge: "PACK COMPLETO 🔥",
