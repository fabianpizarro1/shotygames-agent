...
for (const id of ids) {
  ...
  // Comisión real de Meta desde el 2026-09-25: 3% (antes 20%) — decisions/log.md.
  ...
  for (const n of [1,2,3]) {
    ...
    console.log(`   ${n}u → vender ${usd(precio)} · CPA máx ${usd(r.cpaMaximo)} (real Meta ${usd(r.cpaMaximo/1.03)}) · utilidad ${usd(r.utilidadPorPedido)} @CPA10`);
  }
  console.log('');
}
